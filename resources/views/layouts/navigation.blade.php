        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        @auth
                            <x-dropdown-link :href="route('seeker.dashboard')">
                                {{ __('Dashboard') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('seeker.profile.show')">
                                {{ __('My Profile') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('seeker.applications.progress')">
                                {{ __('Applications') }}
                            </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                ...
                <x-responsive-nav-link :href="route('seeker.profile.show')" :active="request()->routeIs('seeker.profile.show')">
                    {{ __('My Profile') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('seeker.applications.progress')" :active="request()->routeIs('seeker.applications.progress')">
                    {{ __('Applications') }}
                </x-responsive-nav-link>
            @endauth
        </div>
